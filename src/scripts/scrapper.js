...
async function getContacInfo() {
  try {
    ...
    console.log('🚀 scrapper.js ~ line 33 ~ getContacInfo ~ error', error);
...
function getEspecificInfo (selector) {
  try {
    ...
    // eslint-disable-next-line no-console
    console.log('🚀scrapper.js ~ line 65 ~ getEspecificInfo ~ error', error);
  }
}
...
async function scrap () {
  try {
    ...
    // eslint-disable-next-line no-console
    console.log('🚀 ~ file: scrapper.js ~ line 102 ~ scrap ~ error', error);
